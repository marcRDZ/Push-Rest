...
package com.rodriguezdiaz.marcos.restwebservice.messaging;
...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.19.1 of the messaging library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class MessagingEndpoint {
    ...
    /**
     * Create a request for the method "messagingEndpoint.pushNotification".
     *
     * This request holds the parameters needed by the messaging server.  After setting any optional
     * parameters, call the {@link PushNotification#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.rodriguezdiaz.marcos.restwebservice.messaging.model.RegistrationRecord}
     * @return the request
     */
    public PushNotification pushNotification(com.rodriguezdiaz.marcos.restwebservice.messaging.model.RegistrationRecord content) throws java.io.IOException {
      PushNotification result = new PushNotification(content);
      initialize(result);
      return result;
    }

    public class PushNotification extends MessagingRequest<Void> {

      private static final String REST_PATH = "pushNotification";

      /**
       * Create a request for the method "messagingEndpoint.pushNotification".
       *
       * This request holds the parameters needed by the the messaging server.  After setting any
       * optional parameters, call the {@link PushNotification#execute()} method to invoke the remote
       * operation. <p> {@link PushNotification#initialize(com.google.api.client.googleapis.services.Abs
       ...
       * @since 1.13
       */
      protected PushNotification(com.rodriguezdiaz.marcos.restwebservice.messaging.model.RegistrationRecord content) {
        super(Messaging.this, "POST", REST_PATH, content, Void.class);
      }

      @Override
      public PushNotification setAlt(java.lang.String alt) {
        return (PushNotification) super.setAlt(alt);
      }

      @Override
      public PushNotification setFields(java.lang.String fields) {
        return (PushNotification) super.setFields(fields);
      }

      @Override
      public PushNotification setKey(java.lang.String key) {
        return (PushNotification) super.setKey(key);
      }

      @Override
      public PushNotification setOauthToken(java.lang.String oauthToken) {
        return (PushNotification) super.setOauthToken(oauthToken);
      }

      @Override
      public PushNotification setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (PushNotification) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public PushNotification setQuotaUser(java.lang.String quotaUser) {
        return (PushNotification) super.setQuotaUser(quotaUser);
      }

      @Override
      public PushNotification setUserIp(java.lang.String userIp) {
        return (PushNotification) super.setUserIp(userIp);
      }

      @Override
      public PushNotification set(String parameterName, Object value) {
        return (PushNotification) super.set(parameterName, value);
      }
    }
    /**
