 ...
 * on 2015-02-15 at 19:23:14 UTC 
 * Modify at your own risk.
 */

package com.rodriguezdiaz.marcos.restwebservice.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://fifth-moment-846.appspot.com/_ah/api/";
  ...
  /**
   * Create a request for the method "listActivities".
   *
   * This request holds the parameters needed by the registration server.  After setting any optional
   * parameters, call the {@link ListActivities#execute()} method to invoke the remote operation.
   *
   * @param idPhone
   * @return the request
   */
  public ListActivities listActivities(java.lang.String idPhone) throws java.io.IOException {
    ListActivities result = new ListActivities(idPhone);
    initialize(result);
    return result;
  }

  public class ListActivities extends RegistrationRequest<com.rodriguezdiaz.marcos.restwebservice.registration.model.CollectionResponseRegistrationRecord> {

    private static final String REST_PATH = "registrationrecord/{idPhone}";

    /**
     * Create a request for the method "listActivities".
     *
     * This request holds the parameters needed by the the registration server.  After setting any
     * optional parameters, call the {@link ListActivities#execute()} method to invoke the remote
     * operation. <p> {@link ListActivities#initialize(com.google.api.client.googleapis.services.Abstr
     ...
     * @since 1.13
     */
    protected ListActivities(java.lang.String idPhone) {
      super(Registration.this, "POST", REST_PATH, null, com.rodriguezdiaz.marcos.restwebservice.registration.model.CollectionResponseRegistrationRecord.class);
      this.idPhone = com.google.api.client.util.Preconditions.checkNotNull(idPhone, "Required parameter idPhone must be specified.");
    }

    @Override
    public ListActivities setAlt(java.lang.String alt) {
      return (ListActivities) super.setAlt(alt);
    }

    @Override
    public ListActivities setFields(java.lang.String fields) {
      return (ListActivities) super.setFields(fields);
    }

    @Override
    public ListActivities setKey(java.lang.String key) {
      return (ListActivities) super.setKey(key);
    }

    @Override
    public ListActivities setOauthToken(java.lang.String oauthToken) {
      return (ListActivities) super.setOauthToken(oauthToken);
    }

    @Override
    public ListActivities setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ListActivities) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ListActivities setQuotaUser(java.lang.String quotaUser) {
      return (ListActivities) super.setQuotaUser(quotaUser);
    }

    @Override
    public ListActivities setUserIp(java.lang.String userIp) {
      return (ListActivities) super.setUserIp(userIp);
    }
    ...
    public ListActivities setIdPhone(java.lang.String idPhone) {
      this.idPhone = idPhone;
      return this;
    }

    @Override
    public ListActivities set(String parameterName, Object value) {
      return (ListActivities) super.set(parameterName, value);
    }
  }
  ...
  public class ListDevices extends RegistrationRequest<com.rodriguezdiaz.marcos.restwebservice.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, com.rodriguezdiaz.marcos.restwebservice.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   * @return the request
   */
  public Record record(java.lang.String regId, java.lang.String idPhone, java.lang.String moment, java.lang.String typeAct) throws java.io.IOException {
    Record result = new Record(regId, idPhone, moment, typeAct);
    initialize(result);
    return result;
  }

  public class Record extends RegistrationRequest<Void> {

    private static final String REST_PATH = "registerActivity/{regId}/{idPhone}/{moment}/{typeAct}";
     ...
     * @since 1.13
     */
    protected Record(java.lang.String regId, java.lang.String idPhone, java.lang.String moment, java.lang.String typeAct) {
      ...
      this.idPhone = com.google.api.client.util.Preconditions.checkNotNull(idPhone, "Required parameter idPhone must be specified.");
      this.moment = com.google.api.client.util.Preconditions.checkNotNull(moment, "Required parameter moment must be specified.");
      this.typeAct = com.google.api.client.util.Preconditions.checkNotNull(typeAct, "Required parameter typeAct must be specified.");
    }
    ...
    public Record setRegId(java.lang.String regId) {
      this.regId = regId;
      return this;
    }
    ...
    public Record setIdPhone(java.lang.String idPhone) {
      this.idPhone = idPhone;
      return this;
    }
    ...
    public Record setMoment(java.lang.String moment) {
      this.moment = moment;
      return this;
    }
    ...
    public Record setTypeAct(java.lang.String typeAct) {
